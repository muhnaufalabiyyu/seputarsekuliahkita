            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; <?= @$pengaturan->nama_web ?> <?= date('Y') ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?= base_url('admin/keluar') ?>">Keluar</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?= base_url('assets/admin/') ?>vendor/ckeditor/plugin.js"></script>
